...
TEST(KernelThunkInvariantBuffersTest, MissingBuffer) {
#ifdef NDEBUG
...
TEST(KernelThunkInvariantBuffersTest, ExtraInputOutputBuffer) {
#ifdef NDEBUG
  GTEST_SKIP() << "Invariant buffers check is disabled in optimized build.";
#endif
...
TEST(KernelThunkInvariantBuffersTest, ExtraIncorrectBuffer) {
#ifdef NDEBUG
  GTEST_SKIP() << "Invariant buffers check is disabled in optimized build.";
#endif
