...
ENTRY main {
  ...
  %concatenate.2145 = f8e4m3fn[8,640,10240]{2,1,0} concatenate(f8e4m3fn[8,640,5120]{2,1,0} %parameter_1.5, f8e4m3fn[8,640,5120]{2,1,0} %parameter_2), dimensions={2}
  %dot.6237 = f32[8,16,10240]{2,1,0} dot(f8e4m3fn[16,8,640]{2,1,0} %bitcast.73421, f8e4m3fn[8,640,10240]{2,1,0} %concatenate.2145), lhs_batch_dims={1}, lhs_contracting_dims={2}, rhs_batch_dims={0}, rhs_contracting_dims={1}
  ROOT %convert.20480 = bf16[8,16,10240]{2,1,0} convert(f32[8,16,10240]{2,1,0} %dot.6237)
})";
