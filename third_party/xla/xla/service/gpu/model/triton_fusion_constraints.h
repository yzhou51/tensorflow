...
#ifndef XLA_SERVICE_GPU_MODEL_TRITON_FUSION_CONSTRAINTS_H_
#define XLA_SERVICE_GPU_MODEL_TRITON_FUSION_CONSTRAINTS_H_

namespace xla {
namespace gpu {

// Triton-specific constraints on tile sizes.
class TritonFusionConstraints : public EmitterSpecificConstraints {
 public:
  static EmitterSpecificConstraintsBuilder GetBuilder();

  explicit TritonFusionConstraints(
...
#endif  // XLA_SERVICE_GPU_MODEL_TRITON_FUSION_CONSTRAINTS_H_
