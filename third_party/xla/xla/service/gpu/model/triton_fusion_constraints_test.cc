...
class TritonFusionConstraintsTest : public HloTestBase {
 public:
    ...
    SymbolicTileAnalysisOrError analysis_or_error =
        SymbolicTileAnalysis::AnalyzeComputation(
            *module->entry_computation()
            ...
            &mlir_context_, TritonFusionConstraints::GetBuilder());
...
TEST_F(TritonFusionConstraintsTest, TritonSpecificConstraintsAreEnforced) {
