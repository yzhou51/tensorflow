...
absl::Status ConvertMlirHloToHlo(mlir::ModuleOp module,
  ...
  if (auto xla_entry_computation_result_layout =
          module->getAttrOfType<mlir::DenseIntElementsAttr>(
              kMhloXlaEntryComputationResultLayout)) {
    mhlo::ExportModuleEntryComputationResultLayout(
        xla_entry_computation_result_layout, hlo_module, root_index);
  }
  if (auto xla_entry_computation_result_tiles =
          module->getAttrOfType<mlir::ArrayAttr>(
              kMhloXlaEntryComputationResultTiles)) {
    mhlo::ExportModuleEntryComputationResultTiles(
        xla_entry_computation_result_tiles, hlo_module, root_index);
  }
